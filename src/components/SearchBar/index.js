    ...
    <div className={ styles.searchBar }>
      ...
      <div className={ styles.bottom }>
        <div className={ styles.filterInputs }>
          <label htmlFor="ingredient" className={ styles.radioInput }>
            <input
          ...
          <label htmlFor="name" className={ styles.radioInput }>
            <input
          ...
          <label htmlFor="firstLetter" className={ styles.radioInput }>
            <input
